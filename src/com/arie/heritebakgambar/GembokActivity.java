...
public class GembokActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_gembok);
	...
	public void cekJawaban(View v){
		String  jawabanBenar = "GEMBOK RUMAH";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.gembok, menu);
		return true;
	}
